...
class ReportsDashboard:
   ...
   def load_data(_self):
       ...
       return data
   # Column detection in excel sheet for data retrieval
   ...
   def to_pdf(self, df, title):
       def plotly_to_image(fig, width=700, height=400):
           # Uses Plotly's modern built-in image export engine
           img_bytes = fig.to_image(format="png", width=width, height=height, engine="auto")
       ...
       if self.status_col and self.status_col in df.columns:
           ...
           if len(status_counts) > 0:
               ...
               elements.append(RLImage(plotly_to_image(fig, width=450, height=280), width=450, height=280))                  
               elements.append(Spacer(1, 15))
       ...
       if self.date_col and self.date_col in df.columns:
           ...
           if not temp.empty:
               ...
               elements.append(Spacer(1, 5))
               elements.append(RLImage(plotly_to_image(fig2, width=450, height=280), width=450, height=280))
               elements.append(Spacer(1, 15))
       # Table page
